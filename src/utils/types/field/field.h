...
class FieldLine {
  public:
    ...
    FieldLine(const std::string &marking_name, double p1_x_, double p1_y_, double p2_x_,
...
class FieldCircularArc {
  public:
    ...
    FieldCircularArc(const std::string &marking_name, double center_x_, double center_y_,
...
class FieldTriangle {
  public:
    ...
    FieldTriangle(const std::string &marking_name, double p1_x_, double p1_y_, double p2_x_,
                  double p2_y_, double p3_x_, double p3_y_, double thickness_);
};
