...
Entity::Entity(EntityType type) : _entityType(type) {

    _id++; // global id +1
    // default priority is 0
    // default loop frequency is 60
    // enabling by default
    // enabling loop by default
}
...
int Entity::entityId() { return _id; }
...
EntityType Entity::entityType() { return _entityType; }

void Entity::startTimer() { _entityTimer.start(); }

void Entity::stopTimer() { _entityTimer.stop(); }
